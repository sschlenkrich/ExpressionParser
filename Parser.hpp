...
/**
 ** \file Parser.hpp
 ** Define the QuantLib::Scripting::parser class.
 */
...
#line 56 "Parser.hpp" // lalr1.cc:377
...
#line 133 "Parser.hpp" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_DATE (const std::string& v, const location_type& l);

    static inline
    symbol_type
    make_IFTHENELSE (const std::string& v, const location_type& l);
    ...
    static inline
    symbol_type
    make_PAY (const std::string& v, const location_type& l);
    ...
    Parser (FlexBisonDriver& driver_yyarg, void* yyscanner_yyarg);
    virtual ~Parser ();
  ...
  Parser::symbol_type
  Parser::make_NUMBER (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_NUMBER, v, l);
  }

  Parser::symbol_type
  Parser::make_DATE (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_DATE, v, l);
  }

  Parser::symbol_type
  Parser::make_IFTHENELSE (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_IFTHENELSE, v, l);
  }

  Parser::symbol_type
  Parser::make_MIN (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_MIN, v, l);
  }

  Parser::symbol_type
  Parser::make_MAX (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_MAX, v, l);
  }

  Parser::symbol_type
  Parser::make_PAY (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_PAY, v, l);
  }

  Parser::symbol_type
  Parser::make_CACHE (const std::string& v, const location_type& l)
  {
